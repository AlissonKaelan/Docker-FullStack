...
<style scoped>
/* COPIAR O MESMO CSS DO LOGINVIEW PARA MANTER CONSISTÊNCIA */
/* ... (Use o mesmo CSS do LoginView acima) ... */
/* Apenas mude o background do left-panel se quiser diferenciar (ex: verde para #10b981) */
.split-screen { display: flex; min-height: 100vh; font-family: 'Segoe UI', sans-serif; background-color: white; }
.left-panel { flex: 1; background: linear-gradient(135deg, #10b981 0%, #059669 100%); display: flex; align-items: center; justify-content: center; color: white; padding: 40px; position: relative; overflow: hidden; }
...
@media (max-width: 768px) { .split-screen { flex-direction: column; } .left-panel { padding: 30px; text-align: center; } }
</style>